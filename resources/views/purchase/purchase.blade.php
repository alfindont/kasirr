                    ...
                    <div class="card-body">
                        ...
                        @if(Auth::user()->role == 'petugas')
                            <a href="" class="btn btn-primary mb-4" data-bs-toggle="modal"
                                data-bs-target="#modalCreate">Tambah Penjualan</a>
                        @endif        
                        @if ($errors->any())
                        ...
                        <table class="table">
                                <tr>
                                    ...
                                    <th scope="col"><p>Purchase Date</th>
                                    <th scope="col"><p>Total Purchase</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <a href="{{ route('createPdf', ['id'=>$value->id])}}" class="btn btn-success">UnduhBukti</a>
